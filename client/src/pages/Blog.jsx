...
import { assets, blog_data, blogCategories, comments_data } from '../assets/assets'
  ...
  return data ? (
    ...
    <img src={assets.gradientBackground} className='absolute -top-50 -z-1 opacity-50'/>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm:border-primary/35 bg-primary/5 font-medium text-primary'>Poovarasan S</p>
      </div>
