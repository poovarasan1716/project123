...
import CommentTableItem3 from '../../components/admin3/CommentTableItem3'
...
const Comments3 = () => {
  ...
  const fetchComments = async ()=>{
    try {
      const {data} = await axios.get('/api/admin3/comments3')
...
<table className='w-full text-sm text-gray-500'>
  ...
  <tbody>
    ...
    }).map((comment,index)=><CommentTableItem3 key={comment._id} comment={comment} index={index+1} fetchComments={fetchComments}/>)}
  </tbody>
</table>
</div>
    </div>
